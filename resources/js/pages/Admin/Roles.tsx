                ...
                <h3 className="text-lg font-medium text-gray-900 dark:text-white capitalize flex items-center">
                  ...
                  <span 
                    className={`ml-3 inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${
                      ...
                      role.name === 'moderator' ? 'bg-yellow-100 dark:bg-yellow-900 text-yellow-800 dark:text-yellow-200' :
                  ...
                  <div>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
                      {role.permissions.map((permission) => (
                        <div key={permission.id} className="bg-gray-50 dark:bg-gray-700 rounded-md p-3">
                          ...
                          <p className="mt-1 text-xs text-gray-600 dark:text-gray-300">{permission.description}</p>
                        </div>
                      ))}
                    </div>
                  </div>
                ) : (
                  <div className="text-sm text-gray-500 dark:text-gray-400">No permissions assigned</div>
                )}
              </div>
            </div>
          ))}
